 ...
 * limitations under the License.
 */
class bl{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function vl(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Dr(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function _l(e,t,n){vl(e,n),wl(e,(e=>Fr(e,t)||Fr(t,e)))}function wl(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(kl(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function kl(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Us&&Bs("event: "+n.toString()),ir(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xl{toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new bl,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=So(),this.transactionQueueTree_=new il,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}}function Cl(e,t,n){if(e.stats_=mr(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new No(e.repoInfo_,((t,n,i,s)=>{Nl(e,t,n,i,s)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>El(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{se(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Br(e.repoInfo_,t,((t,n,i,s)=>{Nl(e,t,n,i,s)}),(t=>{El(e,t)}),(t=>{!function(e,t){Zs(t,((t,n)=>{Sl(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return pr[n]||(pr[n]=t()),pr[n]}(e.repoInfo_,(()=>new Po(e.stats_,e.server_))),e.infoData_=new Eo,e.infoSyncTree_=new Fa({startListening:(t,n,i,s)=>{let r=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(r=Wa(e.infoSyncTree_,t._path,o),setTimeout((()=>{s("ok")}),0)),r},stopListening:()=>{}}),Sl(e,"connected",!1),e.serverSyncTree_=new Fa({startListening:(t,n,i,s)=>(e.server_.listen(t,i,n,((n,i)=>{const r=s(n,i);_l(e.eventQueue_,t._path,r)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Tl(e){const t=e.infoData_.getNode(new Tr(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Il(e){return(t=(t={timestamp:Tl(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Nl(e,t,n,i,s){e.dataUpdateCount++;const r=new Tr(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(s)if(i){const t=he(n,(e=>yo(e)));o=function(e,t,n,i){const s=$a(e,i);if(s){const i=Xa(s),r=i.path,o=i.queryId,a=Or(r,t),l=Ko.fromObject(n);return Ka(e,r,new Uo(Do(o),a,l))}return[]}(e.serverSyncTree_,r,t,s)}else{const t=yo(n);o=ja(e.serverSyncTree_,r,t,s)}else if(i){const t=he(n,(e=>yo(e)));o=function(e,t,n){const i=Ko.fromObject(n);return Ha(e,new Uo({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,r,t)}else{const t=yo(n);o=Wa(e.serverSyncTree_,r,t)}let a=r;o.length>0&&(a=Ol(e,r)),_l(e.eventQueue_,a,o)}function El(e,t){Sl(e,"connected",t),!1===t&&function(e){Ll(e,"onDisconnectEvents");const t=Il(e),n=So();Ao(e.onDisconnect_,Ir(),((i,s)=>{const r=el(i,s,e.serverSyncTree_,t);Ro(n,i,r)}));let i=[];Ao(n,Ir(),((t,n)=>{i=i.concat(Wa(e.serverSyncTree_,t,n));const s=Wl(e,t);Ol(e,s)})),e.onDisconnect_=So(),_l(e.eventQueue_,Ir(),i)}(e)}function Sl(e,t,n){const i=new Tr("/.info/"+t),s=yo(n);e.infoData_.updateSnapshot(i,s);const r=Wa(e.infoSyncTree_,i,s);_l(e.eventQueue_,i,r)}function Rl(e){return e.nextWriteId_++}function Al(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function Ll(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Bs(n,...t)}function Pl(e,t,n){return Ba(e.serverSyncTree_,t,n)||fo.EMPTY_NODE}function Ml(e,t=e.transactionQueueTree_){if(t||Ul(e,t),rl(t)){const n=Fl(e,t);R(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const i=n.map((e=>e.currentWriteId)),s=Pl(e,t,i);let r=s;const o=s.hash();for(let e=0;e<n.length;e++){const i=n[e];R(0===i.status,"tryToSendTransactionQueue_: items in queue should all be run."),i.status=1,i.retryCount++;const s=Or(t,i.path);r=r.updateChild(s,i.currentOutputSnapshotRaw)}const a=r.val(!0),l=t;e.server_.put(l.toString(),a,(i=>{Ll(e,"transaction put response",{path:l.toString(),status:i});let s=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,s=s.concat(Ua(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();Ul(e,sl(e.transactionQueueTree_,t)),Ml(e,e.transactionQueueTree_),_l(e.eventQueue_,t,s);for(let e=0;e<i.length;e++)ir(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{$s("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}Ol(e,t)}}),o)}(e,ul(t),n)}else al(t)&&ll(t,(t=>{Ml(e,t)}))}function Ol(e,t){const n=Dl(e,t),i=ul(n);return function(e,t,n){if(0===t.length)return;const i=[];let s=[];const r=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const l=t[a],c=Or(n,l.path);let u,h=!1;if(R(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)h=!0,u=l.abortReason,s=s.concat(Ua(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)h=!0,u="maxretry",s=s.concat(Ua(e.serverSyncTree_,l.currentWriteId,!0));else{const n=Pl(e,l.path,r);l.currentInputSnapshot=n;const i=t[a].update(n.val());if(void 0!==i){gl("transaction failed: Data returned ",i,l.path);let t=yo(i);"object"==typeof i&&null!=i&&le(i,".priority")||(t=t.updatePriority(n.getPriority()));const o=l.currentWriteId,a=Il(e),c=tl(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=Rl(e),r.splice(r.indexOf(o),1),s=s.concat(za(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),s=s.concat(Ua(e.serverSyncTree_,o,!0))}else h=!0,u="nodata",s=s.concat(Ua(e.serverSyncTree_,l.currentWriteId,!0))}_l(e.eventQueue_,n,s),s=[],h&&(t[a].status=2,o=t[a].unwatcher,setTimeout(o,Math.floor(0)),t[a].onComplete&&("nodata"===u?i.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):i.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var o;Ul(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)ir(i[e]);Ml(e,e.transactionQueueTree_)}(e,Fl(e,n),i),i}function Dl(e,t){let n,i=e.transactionQueueTree_;for(n=Nr(t);null!==n&&void 0===rl(i);)i=sl(i,n),n=Nr(t=Sr(t));return i}function Fl(e,t){const n=[];return zl(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function zl(e,t,n){const i=rl(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);ll(t,(t=>{zl(e,t,n)}))}function Ul(e,t){const n=rl(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,ol(t,n.length>0?n:void 0)}ll(t,(t=>{Ul(e,t)}))}function Wl(e,t){const n=ul(Dl(e,t)),i=sl(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{jl(e,t)})),jl(e,i),cl(i,(t=>{jl(e,t)})),n}function jl(e,t){const n=rl(t);if(n){const i=[];let s=[],r=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(R(r===t-1,"All SENT items should be at beginning of queue."),r=t,n[t].status=3,n[t].abortReason="set"):(R(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),s=s.concat(Ua(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===r?ol(t,void 0):n.length=r+1,_l(e.eventQueue_,ul(t),s);for(let e=0;e<i.length;e++)ir(i[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ql{get key(){return Mr(this._path)?null:Rr(this._path)}get ref(){return new Vl(this._repo,this._path)}get _queryIdentifier(){const e=Io(this._queryParams),t=Qs(e);return"{}"===t?"default":t}get _queryObject(){return Io(this._queryParams)}isEqual(e){if(!((e=Ce(e))instanceof ql))return!1;const t=this._repo===e._repo,n=Dr(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}}class Vl extends ql{get parent(){const e=Lr(this._path);return null===e?null:new Vl(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}constructor(e,t){super(e,t,new Co,!1)}}!function(e){R(!Pa,"__referenceConstructor has already been defined"),Pa=e}(Vl),function(e){R(!Ma,"__referenceConstructor has already been defined"),Ma=e}(Vl);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const $l={};let Xl=!1;function Kl(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||Vs("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Bs("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Bl(r,s),c=l.repoInfo;void 0!==d&&d.env&&(a=d.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${c.namespace}`,l=Bl(r,s),c=l.repoInfo):o=!l.repoInfo.secure;const u=s&&o?new ar(ar.OWNER):new or(e.name,e.options,t);yl("Invalid Firebase Database URL",l),Mr(l.path)||Vs("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,i){let s=$l[t.name];s||(s={},$l[t.name]=s);let r=s[e.toURLString()];r&&Vs("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new xl(e,Xl,n,i),s[e.toURLString()]=r,r}(c,e,u,new rr(e.name,n));return new Gl(h,e)}class Gl{get _repo(){return this._instanceStarted||(Cl(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Vl(this._repo,Ir())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=$l[t];n&&n[e.key]===e||Vs(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Al(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Vs("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}Br.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Br.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ss="9.20.0",rt(new Te("database",((e,{instanceIdentifier:t})=>Kl(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ht("@firebase/database","0.14.4",e),ht("@firebase/database","0.14.4","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class ac{get path(){return this.path_}get isRoot(){return 0===this.path.length}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=ac.makeFromUrl(e,t)}catch(t){return new ac(e,"")}if(""===n.path)return n;throw i=e,new Yl(Ql.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+i+"'.");var i}static makeFromUrl(e,t){let n=null;const i="([A-Za-z0-9.\\-_]+)";const s=new RegExp("^gs://"+i+"(/(.*))?$","i");function r(e){e.path_=decodeURIComponent(e.path)}const o=t.replace(/[.]/g,"\\."),a=[{regex:s,indices:{bucket:1,path:3},postModify:function(e){"/"===e.path.charAt(e.path.length-1)&&(e.path_=e.path_.slice(0,-1))}},{regex:new RegExp(`^https?://${o}/v[A-Za-z0-9_]+/b/${i}/o(/([^?#]*).*)?$`,"i"),indices:{bucket:1,path:3},postModify:r},{regex:new RegExp(`^https?://${"firebasestorage.googleapis.com"===t?"(?:storage.googleapis.com|storage.cloud.google.com)":t}/${i}/([^?#]*)`,"i"),indices:{bucket:1,path:2},postModify:r}];for(let t=0;t<a.length;t++){const i=a[t],s=i.regex.exec(e);if(s){const e=s[i.indices.bucket];let t=s[i.indices.path];t||(t=""),n=new ac(e,t),i.postModify(n);break}}if(null==n)throw function(e){return new Yl(Ql.INVALID_URL,"Invalid URL '"+e+"'.")}(e);return n}constructor(e,t){this.bucket=e,this.path_=t}}class lc{getPromise(){return this.promise_}cancel(e=!1){}constructor(e){this.promise_=Promise.reject(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class fc{toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new fc(e,t)}get root(){const e=new ac(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return mc(this._location.path)}get storage(){return this._service}get parent(){const e=
/**
 * @license
 * Copyright 2017 Google LLC
 *
